import { BarChart3, CalendarDays, CalendarRange, CreditCard, Home, Hotel, MessageSquare, Package, PawPrint, Scissors, Settings, ShieldCheck, Users, X } from "lucide-react";
