import { BarChart3, Bot, CalendarDays, CalendarRange, CreditCard, Home, Hotel, MessageSquare, Package, PawPrint, Scissors, Settings, ShieldCheck, Smartphone, Users, X, Radio, TabletSmartphone } from "lucide-react";
...
const items = [
  ...
  ["/settings","Settings",Settings],["/staff-mobile","Staff Mobile",TabletSmartphone],["/sms-integration","Two-Way SMS",Radio],["/client-portal","Client Portal",Smartphone],["/ai-receptionist","AI Receptionist",Bot]
] as const;
