...
const seedPets: Pet[] = [
  {
    ...
    color: "Golden",
    sex: "Female",
    fixedStatus: "Spayed (Female)",
    hairLength: "Long Coat",
    birthday: "2022-07-17",
    weightPounds: 64,
    size: "Large",
    ...
    preferredShampoo: "Oatmeal Lavender",
  ...
  },
  {
    ...
    color: "Black",
    sex: "Male",
    fixedStatus: "Neutered (Male)",
    hairLength: "Short Coat",
    birthday: "2021-03-12",
    weightPounds: 76,
    size: "Large",
    microchipNumber: "",
    ...
    preferredShampoo: "De-shed Clarifying",
    vaccinationRabiesExpiresOn: nextYear,
    vaccinationBordetellaExpiresOn: nextYear,
    vaccinationDhppExpiresOn: nextYear,
    photoUrl: "",
...
function fromRow(row: Record<string, unknown>): Pet {
  return {
    ...
    fixedStatus: (row.fixed_status ?? "Intact") as Pet["fixedStatus"],
    hairLength: (row.hair_length ?? "Short Coat") as Pet["hairLength"],
    ...
    preferredShampoo: String(row.preferred_shampoo ?? ""),
    ...
    avatar: (row.avatar ?? (String(row.species) === "Cat" ? "🐈" : "🐕")) as Pet["avatar"],
...
function toRow(input: PetInput) {
  return {
    ...
    sex: input.sex,
    fixed_status: input.fixedStatus,
